...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 查看年龄分布</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">-</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">XX</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">:+</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">PrintTenuringDistribution</span></span></code></pre></div><h3 id="追问-为什么默认晋升年龄是6-不是15" tabindex="-1">追问：为什么默认晋升年龄是6？不是15？ <a class="header-anchor" href="#追问-为什么默认晋升年龄是6-不是15" aria-label="Permalink to &quot;追问：为什么默认晋升年龄是6？不是15？&quot;">​</a></h3><blockquote><p>很多面试官会问&quot;为什么是15&quot;，这里有个关键误解！</p></blockquote><p><strong>核心答案</strong>：默认值其实是 <strong>6</strong>，不是15！</p><p>但15确实是个特殊数字，它来自<strong>对象头的年龄字段</strong>：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>对象头结构 (64位JVM):</span></span>
<span class="line"><span>┌─────────────────────────────────────┐</span></span>
<span class="line"><span>│ Mark Word (64位)                    │</span></span>
<span class="line"><span>│  - 哈希码/GC分代年龄 (25位)         │</span></span>
<span class="line"><span>│  - 偏向锁标志 (1位)                 │</span></span>
<span class="line"><span>│  - 锁状态标志 (2位)                 │</span></span>
<span class="line"><span>│  - 分代年龄 (4位) → 最大值 1111 = 15│</span></span>
<span class="line"><span>└─────────────────────────────────────┘</span></span></code></pre></div><p><strong>为什么是4位？</strong></p><ul><li>对象头空间有限，4位足够表示0-15的年龄</li><li>实际生产中，年龄超过6的对象很少（说明是长寿对象）</li></ul><h3 id="晋升阈值6是怎么得出的" tabindex="-1">晋升阈值6是怎么得出的？ <a class="header-anchor" href="#晋升阈值6是怎么得出的" aria-label="Permalink to &quot;晋升阈值6是怎么得出的？&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>经验公式 + 统计数据：</span></span>
<span class="line"><span></span></span>
<span class="line"><span>1. 大量线上数据分析：</span></span>
<span class="line"><span>   - 98%的对象在第一次Minor GC时就会死亡</span></span>
<span class="line"><span>   - 年龄达到2的对象，80%会成为长寿对象</span></span>
<span class="line"><span>   - 年龄达到4的对象，95%会成为长寿对象</span></span>
<span class="line"><span></span></span>
<span class="line"><span>2. 权衡点：</span></span>
<span class="line"><span>   - 阈值太小 → 对象频繁晋升老年代 → Full GC增加</span></span>
<span class="line"><span>   - 阈值太大 → Survivor区压力增大 → Minor GC时间变长</span></span>
<span class="line"><span>   </span></span>
<span class="line"><span>3. 经验值6：</span></span>
<span class="line"><span>   - 经过大量压测和线上验证</span></span>
<span class="line"><span>   - 在典型业务场景下性价比最高</span></span></code></pre></div><h3 id="如何调整晋升阈值" tabindex="-1">如何调整晋升阈值？ <a class="header-anchor" href="#如何调整晋升阈值" aria-label="Permalink to &quot;如何调整晋升阈值？&quot;">​</a></h3><p><strong>方式一：JVM参数</strong></p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 设置晋升年龄阈值为15</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">-XX:MaxTenuringThreshold</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">=15</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 同时输出年龄分布信息</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">-XX:+PrintTenuringDistribution</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 示例输出：</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># Desired survivor size 5242880 bytes, threshold 6 (max 6)</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># - age   1:    12345678 bytes</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># - age   2:     2345678 bytes</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># - age   3:      345678 bytes</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># - age   4:       45678 bytes</span></span></code></pre></div><p><strong>方式二：动态调整（无需重启）</strong></p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># JMX连接后调用</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">com.sun.management:type</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">=HotSpotDiagnostic.setVMOption</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">&quot;MaxTenuringThreshold&quot;</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">,</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 15</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 或者使用jinfo</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">jinfo</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -flag</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> MaxTenuringThreshold=</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">&lt;</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">valu</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">e</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">&gt;</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> &lt;</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">pi</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">d</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">&gt;</span></span></code></pre></div><h3 id="调整依据-什么时候需要调大-调小" tabindex="-1">调整依据：什么时候需要调大/调小？ <a class="header-anchor" href="#调整依据-什么时候需要调大-调小" aria-label="Permalink to &quot;调整依据：什么时候需要调大/调小？&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>┌─────────────────────────────────────────────────────────────┐</span></span>
<span class="line"><span>│  需要调小 (如 4)                                            │</span></span>
<span class="line"><span>├─────────────────────────────────────────────────────────────┤</span></span>
<span class="line"><span>│  • 老年代频繁Full GC                                        │</span></span>
<span class="line"><span>│  • 对象生命周期短                                          │</span></span>
<span class="line"><span>│  • 大对象多                                               │</span></span>
<span class="line"><span>│  • 症状：Old区增长快，Full GC频繁                          │</span></span>
<span class="line"><span>└─────────────────────────────────────────────────────────────┘</span></span>
<span class="line"><span></span></span>
<span class="line"><span>┌─────────────────────────────────────────────────────────────┐</span></span>
<span class="line"><span>│  需要调大 (如 10-15)                                        │</span></span>
<span class="line"><span>├─────────────────────────────────────────────────────────────┤</span></span>
<span class="line"><span>│  • Minor GC时间过长                                         │</span></span>
<span class="line"><span>│  • 对象生命周期长                                          │</span></span>
<span class="line"><span>│  • 内存充足                                                │</span></span>
<span class="line"><span>│  • 症状：Survivor区经常满，复制开销大                      │</span></span>
<span class="line"><span>└─────────────────────────────────────────────────────────────┘</span></span></code></pre></div><h3 id="实际案例-阈值调整效果" tabindex="-1">实际案例：阈值调整效果 <a class="header-anchor" href="#实际案例-阈值调整效果" aria-label="Permalink to &quot;实际案例：阈值调整效果&quot;">​</a></h3><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 调整前：频繁Full GC</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">java</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -Xms4g</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -Xmx4g</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -XX:MaxTenuringThreshold=6</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -XX:+UseG1GC</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> \\</span></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">     -Xlog:gc</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">*</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:gc.log</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 查看日志发现：大量年龄2-4的对象晋升老年代</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 调整后：</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">java</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -Xms4g</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -Xmx4g</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -XX:MaxTenuringThreshold=10</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -XX:+UseG1GC</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> \\</span></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">     -XX:+PrintTenuringDistribution</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -Xlog:gc</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">*</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:gc.log</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 效果：减少了约30%的Full GC</span></span></code></pre></div><h3 id="g1和zgc的阈值策略" tabindex="-1">G1和ZGC的阈值策略 <a class="header-anchor" href="#g1和zgc的阈值策略" aria-label="Permalink to &quot;G1和ZGC的阈值策略&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>G1:</span></span>
<span class="line"><span>- 默认也是6，但G1有更智能的动态调整</span></span>
<span class="line"><span>-XX:InitialTenuringThreshold=6</span></span>
<span class="line"><span>-XX:MaxTenuringThreshold=15</span></span>
<span class="line"><span></span></span>
<span class="line"><span>ZGC:</span></span>
<span class="line"><span>- 不分代，不需要调整这个参数</span></span>
<span class="line"><span>- 采用着色指针并发回收</span></span></code></pre></div><h3 id="动态年龄计算" tabindex="-1">动态年龄计算 <a class="header-anchor" href="#动态年龄计算" aria-label="Permalink to &quot;动态年龄计算&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>JDK引入&quot;动态年龄&quot;：</span></span>
